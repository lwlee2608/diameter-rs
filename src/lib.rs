...
//!
//! [`server`]: https://github.com/lwlee2608/diameter-rs/blob/v0.7.1/examples/server.rs
//! [`client`]: https://github.com/lwlee2608/diameter-rs/blob/v0.7.1/examples/client.rs
